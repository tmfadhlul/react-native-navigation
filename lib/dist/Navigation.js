...
class NavigationRoot {
    ...
    push(componentId, layout) {
        if (this.prevComponentId !== componentId) {
            this.prevComponentId = componentId
    ...
    pop(componentId, mergeOptions) {
        if (this.prevComponentId !== componentId) {
            this.prevComponentId = componentId
            return this.commands.pop(componentId, layout);
        }
    }
    /**
    ...
    popTo(componentId, mergeOptions) {
        if (this.prevComponentId !== componentId) {
            this.prevComponentId = componentId
            return this.commands.popTo(componentId, layout);
        }
    }
    /**
    ...
    popToRoot(componentId, mergeOptions) {
        if (this.prevComponentId !== componentId) {
            this.prevComponentId = componentId
            return this.commands.popToRoot(componentId, layout);
        }
    }
    /**
